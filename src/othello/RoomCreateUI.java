...
public class RoomCreateUI extends JPanel implements MouseListener{
	...
	public RoomCreateUI(Client c,OthelloUI oi){
		...
		handi.setFont(new Font("富士ポップ", Font.BOLD, 20));
		...
		handiRadio1.setFont(new Font("富士ポップ", Font.BOLD, 18));
		...
		handiRadio2.setFont(new Font("富士ポップ", Font.BOLD, 18));
		...
		handiRadio3.setFont(new Font("富士ポップ", Font.BOLD, 18));
		...
		aikoRadio2.setFont(new Font("富士ポップ", Font.BOLD, 18));
